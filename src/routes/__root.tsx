...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FPI STOR — متجر الاشتراكات والألعاب" },
      { property: "og:description", content: "اشتراكات، ألعاب، كفت كارد وخدمات رقمية بالدينار العراقي مع تسليم فوري." },
