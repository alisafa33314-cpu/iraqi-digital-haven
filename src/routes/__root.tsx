...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "FPI STOR | متجر رقمي عراقي - اشتراكات وحسابات" },
      { name: "twitter:description", content: "متجر FPI STOR لبيع الاشتراكات الرقمية والحسابات والألعاب بأفضل الأسعار في العراق." },
      ...
      { name: "keywords", content: "fpistor, fpistor.com, FPI STOR, متجر اف بي اي, اشتراكات رقمية, متجر رقمي, ألعاب, كفت كارد, العراق, دينار عراقي" },
    ],
    links: [
