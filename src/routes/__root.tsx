    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Store",
          "@id": "https://fpistor.com/#store",
          name: "FPI STOR",
          alternateName: ["متجر اف بي اي", "FPI STOR"],
          ...
          description: "متجر FPI STOR (متجر اف بي اي) لبيع الاشتراكات الرقمية والحسابات والألعاب بأفضل الأسعار في العراق.",
          areaServed: "IQ",
