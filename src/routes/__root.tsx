...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "FPI STOR | متجر اف بي اي - متجر رقمي عراقي" },
      { name: "twitter:description", content: "متجر FPI STOR (متجر اف بي اي) لبيع الاشتراكات الرقمية والحسابات والألعاب بأفضل الأسعار في العراق." },
      ...
      { name: "keywords", content: "fpistor, fpistor.com, FPI STOR, متجر اف بي اي, اف بي اي ستور, FPI ستور, اشتراكات رقمية, متجر رقمي عراقي, ألعاب, كفت كارد, العراق, دينار عراقي" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "OnlineStore",
          name: "FPI STOR",
          alternateName: "متجر اف بي اي",
          url: "https://fpistor.com",
          logo: "https://iraqi-digital-haven.lovable.app/__l5e/assets-v1/51bf0f38-abc1-4134-90f5-25e16673c9be/fpi-store-logo.png",
          image: "https://iraqi-digital-haven.lovable.app/__l5e/assets-v1/51bf0f38-abc1-4134-90f5-25e16673c9be/fpi-store-logo.png",
          description: "متجر FPI STOR لبيع الاشتراكات الرقمية والحسابات والألعاب بأفضل الأسعار في العراق",
          areaServed: "IQ",
          currenciesAccepted: "IQD",
          potentialAction: {
            "@type": "SearchAction",
            target: "https://fpistor.com/search?q={search_term_string}",
